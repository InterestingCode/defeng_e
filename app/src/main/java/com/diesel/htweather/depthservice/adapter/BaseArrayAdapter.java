...
public abstract class BaseArrayAdapter<T, H> extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		H holder;
		if (rowView == null) {
			rowView = this.getLayoutInflater().inflate(mResource, null);
			holder = createHolder();
		...
		initDefaultHolder(position, holder, item);
	 ...
	 *            当前对象
	 */
	protected abstract void initDefaultHolder(int position, H holder, T item);
