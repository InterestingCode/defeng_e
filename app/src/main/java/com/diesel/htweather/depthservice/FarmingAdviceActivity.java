...
public class FarmingAdviceActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tvSuggestContent.setText(Html.fromHtml(suggestBean.getContent(), new HtmlImageGetter(), null));
    ...
    class LoadImage extends AsyncTask<Object, Void, Bitmap> {
        ...
        protected void onPostExecute(Bitmap bitmap) {
            if (bitmap != null) {
                 ...
                 *
                 */
                tvSuggestContent.invalidate();
                CharSequence t = tvSuggestContent.getText();
                tvSuggestContent.setText(t);
            }
        }
