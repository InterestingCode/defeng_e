            ...
            public void onResponse(String response, int id) {
                ...
                try {
                    ...
                    if (null != resJO && resJO.status == 0) {
                        ...
                        tvGrowthDetailContent.setText(Html.fromHtml(bean.getContent(), new HtmlImageGetter(), null));
                    } else {
    ...
    class LoadImage extends AsyncTask<Object, Void, Bitmap> {
        ...
        protected void onPostExecute(Bitmap bitmap) {
            if (bitmap != null) {
                 ...
                 *
                 */
                tvGrowthDetailContent.invalidate();
                CharSequence t = tvGrowthDetailContent.getText();
                tvGrowthDetailContent.setText(t);
