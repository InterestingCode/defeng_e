...
public class UberProgressView extends View {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            stationaryCircleColor = typedArray.getColor(R.styleable.UberProgressView_stationary_circle_color, Color
                    .parseColor(CIRCLE_COLOR));
            fadingCircleColor = typedArray.getColor(R.styleable.UberProgressView_fading_circle_color, Color
                    .parseColor(CIRCLE_COLOR));
            oribitingCircleColor = typedArray.getColor(R.styleable.UberProgressView_orbiting_circle_color, Color
                    .parseColor(CIRCLE_COLOR));
