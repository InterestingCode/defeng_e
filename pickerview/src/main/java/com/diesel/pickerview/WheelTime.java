...
import com.diesel.pickerview.TimePickerView.Type;
import com.diesel.pickerview.adapter.NumericWheelAdapter;
...
public class WheelTime {
        ...
        OnItemSelectedListener wheelListener_month = new OnItemSelectedListener() {
            ...
            public void onItemSelected(int index) {
                ...
                if (list_big.contains(String.valueOf(month_num))) {
                    ...
                    if (((wv_year.getCurrentItem()) % 4 == 0
                            && (wv_year.getCurrentItem()) % 100 != 0)
    ...
    public String getTime() {
        ...
        sb.append((wv_year.getCurrentItem())).append("-").append((wv_month.getCurrentItem()))
                .append("-").append((wv_day.getCurrentItem())).append(" ")
